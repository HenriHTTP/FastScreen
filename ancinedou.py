...
def count_ancidedou(data_desejada=None):
    ...
    urls = [
        f"https://www.in.gov.br/consulta/-/buscar/dou?q=*&s=todos&exactDate={data_desejada}&sortType=0&delta=20&orgPrin=Minist%C3%A9rio+da+Cultura&orgSub=Ag%C3%AAncia+Nacional+do+Cinema",
    ]
