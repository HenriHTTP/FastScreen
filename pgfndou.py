...
def count_pgfndou():
    urls = [
        "https://www.in.gov.br/consulta/-/buscar/dou?q=*&s=todos&exactDate=dia&sortType=0&delta=20&orgPrin=Minist%C3%A9rio+da+Fazenda&orgSub=Procuradoria-Geral+da+Fazenda+Nacional"
    ]
