...
def main():
    ...
    data_desejada = '15-12-2023'  # Substitua isso pela data que você deseja
    ...
    scripts = [
        ...
        #{'nome': 'A.G.U', 'funcao': lambda: retry_on_failure (agu.count_agu)},
        #{'nome': 'A.G.U-V3', 'funcao': aguv3.AGUV3},
